...
private:
	...
	AttackData attackData[ShenAttackNum];	//Attack data
...
public:
	...
	//Get the attack power
	GLfloat GetAttackPower() { if(state == Shen_Passive_Attack) { return attackData[ShenAttack1].AttackPower;} if(state == Shen_Attack2) { return attackData[ShenAttack2].AttackPower;} if(state == Shen_Crit) { return attackData[ShenAttackCrit].AttackPower;} return 0.0; }
	GLboolean GetAttackState() { if(state == Shen_Passive_Attack) { return attackData[ShenAttack1].Attacking;} if(state == Shen_Attack2) { return attackData[ShenAttack2].Attacking;} if(state == Shen_Crit) { return attackData[ShenAttackCrit].Attacking;} return GL_FALSE; }
	GLboolean GetAttackTiming() { if(state == Shen_Passive_Attack) { return attackData[ShenAttack1].AttackTiming;} if(state == Shen_Attack2) { return attackData[ShenAttack2].AttackTiming;} if(state == Shen_Crit) { return attackData[ShenAttackCrit].AttackTiming;} return GL_FALSE; }
