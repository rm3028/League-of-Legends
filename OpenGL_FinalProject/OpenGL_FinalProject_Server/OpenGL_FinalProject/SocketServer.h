...
public:
	...
	//傳送訊息給 client 端
	void SocketServer ::sendCoordinate(float x,float y,float z,int state,float locAngle,float moveAngle,int mCurrentList,float health,int death){
	...
	void SocketServer::LoadXml(string file)
	{	
